...
locals {
  tag_values_sql_account = replace(local.tag_values_sql, "__DIMENSIONS__", "account_id")
  tag_values_sql_region  = replace(local.tag_values_sql, "__DIMENSIONS__", "region, account_id")
}

benchmark "tag_values" {
  title       = "Tag Values"
  description = "TODO"
  children = [
    control.accessanalyzer_analyzer_tag_values,
    control.api_gateway_stage_tag_values,
    control.cloudfront_distribution_tag_values,
    control.cloudtrail_trail_tag_values,
    control.cloudwatch_alarm_tag_values,
    control.cloudwatch_log_group_tag_values,
    control.codebuild_project_tag_values,
    control.codecommit_repository_tag_values,
    control.codepipeline_pipeline_tag_values,
    control.config_rule_tag_values,
    control.dax_cluster_tag_values,
    control.directory_service_directory_tag_values,
    control.dms_replication_instance_tag_values,
    control.dynamodb_table_tag_values,
    control.ebs_snapshot_tag_values,
    control.ebs_volume_tag_values,
    control.ec2_application_load_balancer_tag_values,
    control.ec2_classic_load_balancer_tag_values,
    control.ec2_gateway_load_balancer_tag_values,
    control.ec2_instance_tag_values,
    control.ec2_network_load_balancer_tag_values,
    control.ec2_reserved_instance_tag_values,
    control.ecr_repository_tag_values,
    control.ecs_container_instance_tag_values,
    control.ecs_service_tag_values,
    control.efs_file_system_tag_values,
    control.eks_addon_tag_values,
    control.eks_cluster_tag_values,
    control.eks_identity_provider_config_tag_values,
    control.elastic_beanstalk_application_tag_values,
    control.elastic_beanstalk_environment_tag_values,
    control.elasticache_cluster_tag_values,
    control.elasticsearch_domain_tag_values,
    control.eventbridge_rule_tag_values,
    control.guardduty_detector_tag_values,
    control.iam_role_tag_values,
    control.iam_server_certificate_tag_values,
    control.iam_user_tag_values,
    control.inspector_assessment_template_tag_values,
    control.kinesis_firehose_delivery_stream_tag_values,
    control.kms_key_tag_values,
    control.lambda_function_tag_values,
    control.rds_db_cluster_tag_values,
    control.rds_db_cluster_parameter_group_tag_values,
    control.rds_db_cluster_snapshot_tag_values,
    control.rds_db_instance_tag_values,
    control.rds_db_option_group_tag_values,
    control.rds_db_parameter_group_tag_values,
    control.rds_db_snapshot_tag_values,
    control.rds_db_subnet_group_tag_values,
    control.redshift_cluster_tag_values,
    control.route53_domain_tag_values,
    control.route53_resolver_endpoint_tag_values,
    control.s3_bucket_tag_values,
    control.sagemaker_endpoint_configuration_tag_values,
    control.sagemaker_model_tag_values,
    control.sagemaker_notebook_instance_tag_values,
    control.sagemaker_training_job_tag_values,
    control.secretsmanager_secret_tag_values,
    control.ssm_parameter_tag_values,
    control.vpc_tag_values,
    control.vpc_eip_tag_values,
    control.vpc_nat_gateway_tag_values,
    control.vpc_network_acl_tag_values,
    control.vpc_security_group_tag_values,
    control.vpc_vpn_connection_tag_values,
    control.wafv2_ip_set_tag_values,
    control.wafv2_regex_pattern_set_tag_values,
    control.wafv2_rule_group_tag_values,
    control.wafv2_web_acl_tag_values
  ]
...
control "accessanalyzer_analyzer_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_accessanalyzer_analyzer")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "api_gateway_stage_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_api_gateway_stage")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "cloudfront_distribution_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_cloudfront_distribution")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "cloudtrail_trail_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_cloudtrail_trail")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "cloudwatch_alarm_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_cloudwatch_alarm")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "cloudwatch_log_group_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_cloudwatch_log_group")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "codebuild_project_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_codebuild_project")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "codecommit_repository_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_codecommit_repository")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "codepipeline_pipeline_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_codepipeline_pipeline")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "config_rule_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_config_rule")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "dax_cluster_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_dax_cluster")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "directory_service_directory_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_directory_service_directory")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "dms_replication_instance_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_dms_replication_instance")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "dynamodb_table_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_dynamodb_table")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ebs_snapshot_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ebs_snapshot")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ebs_volume_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ebs_volume")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ec2_application_load_balancer_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ec2_application_load_balancer")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ec2_classic_load_balancer_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ec2_classic_load_balancer")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ec2_gateway_load_balancer_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ec2_gateway_load_balancer")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ec2_instance_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ec2_instance")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ec2_network_load_balancer_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ec2_network_load_balancer")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ec2_reserved_instance_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ec2_reserved_instance")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ecr_repository_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ecr_repository")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ecs_container_instance_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ecs_container_instance")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ecs_service_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ecs_service")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "efs_file_system_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_efs_file_system")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "eks_addon_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_eks_addon")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "eks_cluster_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_eks_cluster")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "eks_identity_provider_config_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_eks_identity_provider_config")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "elastic_beanstalk_application_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_elastic_beanstalk_application")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "elastic_beanstalk_environment_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_elastic_beanstalk_environment")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "elasticache_cluster_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_elasticache_cluster")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "elasticsearch_domain_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_elasticsearch_domain")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "eventbridge_rule_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_eventbridge_rule")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "guardduty_detector_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_guardduty_detector")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "iam_role_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_account, "__TABLE_NAME__", "aws_iam_role")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "iam_server_certificate_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_account, "__TABLE_NAME__", "aws_iam_server_certificate")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "iam_user_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_account, "__TABLE_NAME__", "aws_iam_user")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "inspector_assessment_template_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_inspector_assessment_template")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "kinesis_firehose_delivery_stream_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_kinesis_firehose_delivery_stream")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "kms_key_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_kms_key")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "lambda_function_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_lambda_function")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "rds_db_cluster_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_rds_db_cluster")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "rds_db_cluster_parameter_group_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_rds_db_cluster_parameter_group")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "rds_db_cluster_snapshot_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_rds_db_cluster_snapshot")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "rds_db_instance_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_rds_db_instance")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "rds_db_option_group_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_rds_db_option_group")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "rds_db_parameter_group_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_rds_db_parameter_group")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "rds_db_snapshot_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_rds_db_snapshot")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "rds_db_subnet_group_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_rds_db_subnet_group")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "redshift_cluster_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_redshift_cluster")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "route53_domain_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_account, "__TABLE_NAME__", "aws_route53_domain")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "route53_resolver_endpoint_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_route53_resolver_endpoint")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "s3_bucket_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_account, "__TABLE_NAME__", "aws_s3_bucket")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "sagemaker_endpoint_configuration_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_sagemaker_endpoint_configuration")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "sagemaker_model_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_sagemaker_model")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "sagemaker_notebook_instance_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_sagemaker_notebook_instance")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "sagemaker_training_job_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_sagemaker_training_job")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "secretsmanager_secret_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_secretsmanager_secret")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "ssm_parameter_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_ssm_parameter")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "vpc_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_vpc")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "vpc_eip_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_vpc_eip")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "vpc_nat_gateway_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_vpc_nat_gateway")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "vpc_network_acl_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_vpc_network_acl")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "vpc_security_group_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_vpc_security_group")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "vpc_vpn_connection_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_vpc_vpn_connection")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "wafv2_ip_set_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_wafv2_ip_set")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "wafv2_regex_pattern_set_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_wafv2_regex_pattern_set")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "wafv2_rule_group_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_wafv2_rule_group")
  param "tag_values" {
    default = var.tag_values
  }
}
...
control "wafv2_web_acl_tag_values" {
  ...
  sql         = replace(local.tag_values_sql_region, "__TABLE_NAME__", "aws_wafv2_web_acl")
  param "tag_values" {
    default = var.tag_values
  }
}
