...
control "accessanalyzer_analyzer_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_accessanalyzer_analyzer")
  param "tag_limit" {
...
control "cloudfront_distribution_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_cloudfront_distribution")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "cloudtrail_trail_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_cloudtrail_trail")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "cloudwatch_alarm_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_cloudwatch_alarm")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "cloudwatch_log_group_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_cloudwatch_log_group")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "codebuild_project_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_codebuild_project")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "codecommit_repository_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_codecommit_repository")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "codepipeline_pipeline_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_codepipeline_pipeline")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "config_rule_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_config_rule")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "dax_cluster_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_dax_cluster")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "dms_replication_instance_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_dms_replication_instance")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "dynamodb_table_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_dynamodb_table")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "ebs_snapshot_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_ebs_snapshot")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "ebs_volume_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_ebs_volume")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "ec2_application_load_balancer_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_ec2_application_load_balancer")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "ec2_classic_load_balancer_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_ec2_classic_load_balancer")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "ec2_gateway_load_balancer_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_ec2_gateway_load_balancer")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "ec2_network_load_balancer_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_ec2_network_load_balancer")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "ec2_reserved_instance_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_ec2_reserved_instance")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "ecr_repository_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_ecr_repository")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "ecs_container_instance_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_ecs_container_instance")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "ecs_service_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_ecs_service")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "efs_file_system_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_efs_file_system")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "eks_addon_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_eks_addon")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "eks_cluster_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_eks_cluster")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "eks_identity_provider_config_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_eks_identity_provider_config")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "elastic_beanstalk_application_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_elastic_beanstalk_application")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "elastic_beanstalk_environment_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_elastic_beanstalk_environment")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "elasticache_cluster_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_elasticache_cluster")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "elasticsearch_domain_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_elasticsearch_domain")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "eventbridge_rule_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_eventbridge_rule")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "guardduty_detector_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_guardduty_detector")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "iam_role_tag_limit" {
  ...
  sql         = replace(local.limit_sql_account, "__TABLE_NAME__", "aws_iam_role")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "iam_server_certificate_tag_limit" {
  ...
  sql         = replace(local.limit_sql_account, "__TABLE_NAME__", "aws_iam_server_certificate")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "iam_user_tag_limit" {
  ...
  sql         = replace(local.limit_sql_account, "__TABLE_NAME__", "aws_iam_user")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "inspector_assessment_template_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_inspector_assessment_template")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "kinesis_firehose_delivery_stream_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_kinesis_firehose_delivery_stream")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "kms_key_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_kms_key")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "redshift_cluster_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_redshift_cluster")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "route53_domain_tag_limit" {
  ...
  sql         = replace(local.limit_sql_account, "__TABLE_NAME__", "aws_route53_domain")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "s3_bucket_tag_limit" {
  ...
  sql         = replace(local.limit_sql_account, "__TABLE_NAME__", "aws_s3_bucket")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "sagemaker_endpoint_configuration_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_sagemaker_endpoint_configuration")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "sagemaker_model_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_sagemaker_model")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "sagemaker_notebook_instance_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_sagemaker_notebook_instance")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "sagemaker_training_job_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_sagemaker_training_job")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "secretsmanager_secret_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_secretsmanager_secret")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "vpc_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_vpc")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "vpc_eip_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_vpc_eip")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "vpc_nat_gateway_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_vpc_nat_gateway")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "vpc_network_acl_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_vpc_network_acl")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "vpc_security_group_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_vpc_security_group")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "vpc_vpn_connection_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_vpc_vpn_connection")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "wafv2_ip_set_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_wafv2_ip_set")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "wafv2_regex_pattern_set_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_wafv2_regex_pattern_set")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "wafv2_rule_group_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_wafv2_rule_group")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "wafv2_web_acl_tag_limit" {
  ...
  sql         = replace(local.limit_sql_region, "__TABLE_NAME__", "aws_wafv2_web_acl")
  param "tag_limit" {
    default = var.tag_limit
  }
}
