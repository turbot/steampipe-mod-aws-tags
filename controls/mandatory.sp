...
control "accessanalyzer_analyzer_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_accessanalyzer_analyzer")
...
control "api_gateway_stage_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_api_gateway_stage")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "cloudfront_distribution_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_cloudfront_distribution")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "cloudtrail_trail_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_cloudtrail_trail")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "cloudwatch_alarm_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_cloudwatch_alarm")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "cloudwatch_log_group_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_cloudwatch_log_group")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "codebuild_project_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_codebuild_project")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "codecommit_repository_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_codecommit_repository")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "codepipeline_pipeline_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_codepipeline_pipeline")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "config_rule_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_config_rule")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "dax_cluster_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_dax_cluster")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "directory_service_directory_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_directory_service_directory")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "dms_replication_instance_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_dms_replication_instance")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "dynamodb_table_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_dynamodb_table")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ebs_snapshot_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ebs_snapshot")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ebs_volume_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ebs_volume")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ec2_application_load_balancer_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ec2_application_load_balancer")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ec2_classic_load_balancer_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ec2_classic_load_balancer")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ec2_gateway_load_balancer_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ec2_gateway_load_balancer")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ec2_instance_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ec2_instance")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ec2_network_load_balancer_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ec2_network_load_balancer")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ec2_reserved_instance_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ec2_reserved_instance")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ecr_repository_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ecr_repository")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ecs_container_instance_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ecs_container_instance")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ecs_service_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ecs_service")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "efs_file_system_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_efs_file_system")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "eks_addon_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_eks_addon")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "eks_cluster_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_eks_cluster")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "eks_identity_provider_config_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_eks_identity_provider_config")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "elastic_beanstalk_application_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_elastic_beanstalk_application")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "elastic_beanstalk_environment_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_elastic_beanstalk_environment")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "elasticache_cluster_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_elasticache_cluster")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "elasticsearch_domain_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_elasticsearch_domain")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "eventbridge_rule_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_eventbridge_rule")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "guardduty_detector_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_guardduty_detector")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "iam_role_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_iam_role")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "iam_server_certificate_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_iam_server_certificate")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "iam_user_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_iam_user")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "inspector_assessment_template_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_inspector_assessment_template")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "kinesis_firehose_delivery_stream_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_kinesis_firehose_delivery_stream")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "kms_key_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_kms_key")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "lambda_function_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_lambda_function")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "rds_db_cluster_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_rds_db_cluster")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "rds_db_cluster_parameter_group_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_rds_db_cluster_parameter_group")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "rds_db_cluster_snapshot_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_rds_db_cluster_snapshot")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "rds_db_instance_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_rds_db_instance")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "rds_db_option_group_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_rds_db_option_group")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "rds_db_parameter_group_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_rds_db_parameter_group")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "rds_db_snapshot_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_rds_db_snapshot")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "rds_db_subnet_group_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_rds_db_subnet_group")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "redshift_cluster_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_redshift_cluster")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "route53_domain_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_route53_domain")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "route53_resolver_endpoint_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_route53_resolver_endpoint")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "s3_bucket_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_s3_bucket")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "sagemaker_endpoint_configuration_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_sagemaker_endpoint_configuration")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "sagemaker_model_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_sagemaker_model")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "sagemaker_notebook_instance_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_sagemaker_notebook_instance")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "sagemaker_training_job_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_sagemaker_training_job")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "secretsmanager_secret_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_secretsmanager_secret")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "ssm_parameter_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_ssm_parameter")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "vpc_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_vpc")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "vpc_eip_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_vpc_eip")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "vpc_nat_gateway_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_vpc_nat_gateway")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "vpc_network_acl_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_vpc_network_acl")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "vpc_security_group_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_vpc_security_group")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "vpc_vpn_connection_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_vpc_vpn_connection")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "wafv2_ip_set_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_wafv2_ip_set")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "wafv2_regex_pattern_set_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_wafv2_regex_pattern_set")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "wafv2_rule_group_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_wafv2_rule_group")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
...
control "wafv2_web_acl_mandatory" {
  ...
  sql         = replace(local.mandatory_sql, "__TABLE_NAME__", "aws_wafv2_web_acl")
  param "mandatory_tags" {
    default = var.mandatory_tags
  }
}
